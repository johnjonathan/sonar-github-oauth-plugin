 ...
 */
package org.sonar.plugins.github.oauth.api;

import com.thomsonreuters.onesource.sonar.oauth.OAuthPlugin;
import com.thomsonreuters.onesource.sonar.oauth.OAuthQueryParams;
 ...
 * @since 1.0
 */
public abstract class GitHubOAuthClient implements ServerExtension {
    ...
    public GitHubOAuthClient(Settings settings) {
